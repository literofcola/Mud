...
void Skill::Save()
{
    ...
    skillsql += "tick_script, remove_script, target_type, description, cost_description, long_name, cooldown, cost_script, ignore_global) values ";
    ...
    skillsql += ", '" + Utilities::SQLFixQuotes(costFunction) + "'," + Utilities::itos(ignoreGlobal ? 1 : 0) + ")";
    ...
    skillsql += "cooldown=VALUES(cooldown), cost_script=VALUES(cost_script), ignore_global=VALUES(ignore_global)";
