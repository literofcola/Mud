...
void npcEditCmd_agility(Player * ch, std::string argument);
void npcEditCmd_intellect(Player * ch, std::string argument);
void npcEditCmd_strength(Player * ch, std::string argument);
void npcEditCmd_stamina(Player * ch, std::string argument);
void npcEditCmd_wisdom(Player * ch, std::string argument);
void npcEditCmd_spirit(Player * ch, std::string argument);
